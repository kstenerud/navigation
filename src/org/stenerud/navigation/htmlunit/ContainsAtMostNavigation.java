...
/**
 * Make sure the context node list contains at most a specified number of
 * entries. <br>
 ...
 */
public class ContainsAtMostNavigation extends HtmlNavigation
{
	 ...
	 */
	public ContainsAtMostNavigation(Navigation parent, int numEntries)
	{
		super(parent);
