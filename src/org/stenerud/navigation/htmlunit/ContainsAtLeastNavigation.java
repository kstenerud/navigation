...
/**
 * Make sure the context node list contains at least a specified number of
 * entries. <br>
 ...
 */
public class ContainsAtLeastNavigation extends HtmlNavigation
{
	 ...
	 */
	public ContainsAtLeastNavigation(Navigation parent, int numEntries)
	{
		super(parent);
